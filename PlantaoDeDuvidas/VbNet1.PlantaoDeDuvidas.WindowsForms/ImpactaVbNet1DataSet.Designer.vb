...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("ImpactaVbNet1DataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class ImpactaVbNet1DataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As ImpactaVbNet1DataSet = CType(MyBase.Clone,ImpactaVbNet1DataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "ImpactaVbNet1DataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ImpactaVbNet1DataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As ImpactaVbNet1DataSet = New ImpactaVbNet1DataSet()
    ...
    Partial Public Class ClienteDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddClienteRow(ByVal Nome As String, ByVal DataNascimento As Date, ByVal Email As String, ByVal Endereco As String) As ClienteRow
            Dim rowClienteRow As ClienteRow = CType(Me.NewRow,ClienteRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nome, DataNascimento, Email, Endereco}
...
Namespace ImpactaVbNet1DataSetTableAdapters
    ...
    Partial Public Class ClienteTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_"& _ 
                "Nome) AND ([DataNascimento] = @Original_DataNascimento) AND ((@IsNull_Email = 1 "& _ 
                "AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Endereco] = @Original"& _ 
                "_Endereco))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([Nome], [DataNascimento], [Email], [Endereco]) VALUE"& _ 
                "S (@Nome, @DataNascimento, @Email, @Endereco);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Nome, DataNascimento,"& _ 
                " Email, Endereco FROM Cliente WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cliente] SET [Nome] = @Nome, [DataNascimento] = @DataNascimento, [E"& _ 
                "mail] = @Email, [Endereco] = @Endereco WHERE (([Id] = @Original_Id) AND ([Nome] "& _ 
                "= @Original_Nome) AND ([DataNascimento] = @Original_DataNascimento) AND ((@IsNul"& _ 
                "l_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Endereco]"& _ 
                " = @Original_Endereco));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Nome, DataNascimento, Email, Endereco FROM "& _ 
                "Cliente WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.VbNet1.PlantaoDeDuvidas.WindowsForms.My.MySettings.Default.ImpactaVbNet1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Nome, DataNascimento, Email, Endereco FROM dbo.Cliente"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ImpactaVbNet1DataSet.ClienteDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ImpactaVbNet1DataSet.ClienteDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ImpactaVbNet1DataSet.ClienteDataTable = New ImpactaVbNet1DataSet.ClienteDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ImpactaVbNet1DataSet.ClienteDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As ImpactaVbNet1DataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Nome As String, ByVal Original_DataNascimento As Date, ByVal Original_Email As String, ByVal Original_Endereco As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Nome As String, ByVal DataNascimento As Date, ByVal Email As String, ByVal Endereco As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Nome As String, ByVal DataNascimento As Date, ByVal Email As String, ByVal Endereco As String, ByVal Original_Id As Integer, ByVal Original_Nome As String, ByVal Original_DataNascimento As Date, ByVal Original_Email As String, ByVal Original_Endereco As String, ByVal Id As Integer) As Integer
            If (Nome Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Nome")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_DataNascimento,Date)
            If (Original_Email Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Nome As String, ByVal DataNascimento As Date, ByVal Email As String, ByVal Endereco As String, ByVal Original_Id As Integer, ByVal Original_Nome As String, ByVal Original_DataNascimento As Date, ByVal Original_Email As String, ByVal Original_Endereco As String) As Integer
            Return Me.Update(Nome, DataNascimento, Email, Endereco, Original_Id, Original_Nome, Original_DataNascimento, Original_Email, Original_Endereco, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As ImpactaVbNet1DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As ImpactaVbNet1DataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._clienteTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As ImpactaVbNet1DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._clienteTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As ImpactaVbNet1DataSet) As Integer
